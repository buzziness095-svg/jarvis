...
object Lexicon {
    ...
    val settings: Map<String, List<String>> = mapOf(
        ...
        "auto_brightness" to listOf("auto brightness", "adaptive brightness", "ઓટો બ્રાઇટનેસ", "automatic brightness"),
    ...
    val playlist = listOf("playlist", "પ્લેલિસ્ટ", "प्लेलिस्ट")
    val song = listOf("song", "ગીત", "gaana", "गाना", "track", "music", "સંગીત")
    val radio = listOf("radio", "રેડિયો", "रेडियो")
